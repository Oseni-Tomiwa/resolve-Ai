...
export default function Home() {
  return <main className="site-shell">
    ...
    <footer className="site-footer section-wrap"><Link className="brand" href="/"><span className="brand-mark">R</span><span>resolve<span className="brand-accent">ai</span></span></Link><span>© 2026 ResolveAI. Support, made clear.</span><div><Link href="/login">Sign in</Link><Link href="/register">Create account</Link></div></footer>
  </main>;
}
